 ...
 * @author züleyha
 */
public class Drayza extends Beyblade {
    private String kutsalCanavar;

    public Drayza(String beybledeci, int saldiriGucu, int donusHizi, String kutsalCanavar) {
    ...
    public void kutsalCanavarOrtayaCikar() {
       ...
       System.out.println(getBeybledeci()+"nin saldirisi :akaplan pencesi");
    }
}
